      ...
      <div className="w-full max-w-sm mx-auto text-center">
        ...
        <div className="space-y-3 mb-8">
          {features.map((f) => (
            <div
              key={f.title}
              className="bg-white border border-slate-200 rounded-2xl shadow-sm p-5 text-left"
            >
        ...
        <button
          ...
          className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-xl py-3 text-sm transition-colors cursor-pointer mb-8"
        >
          Get Started
        </button>
