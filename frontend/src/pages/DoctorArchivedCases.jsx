                ...
                {c.possibleCondition && (
                  <div className="mt-2">
                    <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-indigo-100 text-indigo-700 rounded-full text-xs font-medium">
                      ...
                      {c.possibleCondition}
                      {c.possibleConditionConfidence && <span className="ml-1 opacity-75">({c.possibleConditionConfidence.charAt(0).toUpperCase() + c.possibleConditionConfidence.slice(1)} confidence)</span>}
                    </span>
                  </div>
                )}
