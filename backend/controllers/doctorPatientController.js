  ...
  try {
    ...
    res.json({
      ...
      chats: chats.map((c) => ({
        ...
        symptoms: c.symptoms || [],
        possibleCondition: c.possibleCondition,
        possibleConditionConfidence: c.possibleConditionConfidence,
  ...
  try {
    ...
    const archived = chats.map((chat) => {
      ...
      return {
        ...
        possibleCondition: chat.possibleCondition,
        possibleConditionConfidence: chat.possibleConditionConfidence,
